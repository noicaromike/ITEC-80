...
function openPage(){
  ...
  if(search === "1964 cafe"){
    window.open("/1964cafe.html");
  }
  if(search === "Cafe Agapita"){
    window.open("/cafeagapita.html");
  }
  if(search === "but first, coffee"){
    window.open("/bfc.html");
  }
  if(search === "el facio kawayanan cafe"){
    window.open("/elfacio.html");
  }
  if(search === "1964 cafe"){
    window.open("/1964cafe.html");
  }
  if(search === "kura cafe"){
    window.open("/kuracafe.html");
  }
